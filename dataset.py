...
class BaseDataset(Dataset):#包装Tensor的Dataset子类
    def __init__(self, model_size='large', phase='train'):
        ...
        data_path = '/home/DATA1/gxj/7-bare-RUN/dd_data/dailydialog_'+phase+'.pkl'
        processed_data_path = '/home/DATA1/gxj/7-bare-RUN/dd_data/dailydialog_processed_'+phase+'.pkl'
